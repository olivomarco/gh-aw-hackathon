...
<a href="{{ '/challenges/1-03-the-watcher/student/' | relative_url }}" class="btn btn--primary">📘 Student Guide</a>
<a href="{{ '/challenges/1-03-the-watcher/coach/' | relative_url }}" class="btn btn--ghost">🎓 Coach Guide</a>
