...
<a href="{{ '/challenges/1-02-safe-and-sound/student/' | relative_url }}" class="btn btn--primary">📘 Student Guide</a>
<a href="{{ '/challenges/1-02-safe-and-sound/coach/' | relative_url }}" class="btn btn--ghost">🎓 Coach Guide</a>
