...
<a href="{{ '/challenges/3-05-ship-it/student/' | relative_url }}" class="btn btn--primary">📘 Student Guide</a>
<a href="{{ '/challenges/3-05-ship-it/coach/' | relative_url }}" class="btn btn--ghost">🎓 Coach Guide</a>
